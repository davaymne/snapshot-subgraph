module.exports = class Data1696121197505 {
    name = 'Data1696121197505'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "sig" ("id" character varying NOT NULL, "account" bytea NOT NULL, "msg_hash" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_cea4b8c97c20154f9d4229eef13" PRIMARY KEY ("id"))`)
    }
